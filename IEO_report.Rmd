...
We can observe that not all genes that are up regulated in some comparison are up-regulated in other comparisons. Furthermore we can extract the names of the other comparisons to see how much they overlap:
...
if (!is.null(GO_tumor_males_not_clear)){
    head(GO_tumor_males_not_clear$GO)
...
if (!is.null(GO_tumor_females_not_clear)){
    head(GO_tumor_females_not_clear$GO)
