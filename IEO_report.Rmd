...
output:
  ...
  pdf_document:
    toc: yes
---
```{r setup0, message = FALSE, warning = FALSE, echo = FALSE, results='asis', cache=TRUE}
library("knitr")
...
```
```{r setup1, message = FALSE, warning = FALSE, echo = FALSE, results='asis', cache=TRUE}
library("knitr")
...
```
```{r setup2, message = FALSE, warning = FALSE, echo = FALSE, results='asis', cache=TRUE}
...
```
```{r setup3, message = FALSE, warning = FALSE, echo = FALSE, results='asis', cache=TRUE}
library("knitr")
...
```{r fun.enrich.tmd, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor5}Figure 25.E: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and males.", autodep=TRUE}
...
```{r fun.enrich.tfu, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor6}Figure 25.F: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and females", autodep=TRUE}
