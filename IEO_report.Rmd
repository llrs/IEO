...
```{r fun.enrich.tumor_tumors, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r fun.enrich.gender_tumors, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r fun.enrich.fmu, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r fun.enrich.fmd, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r fun.enrich.tmd, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r fun.enrich.tfu, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r fun.enrich.visualize_tumors, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
library(xtable)
