...
```{r fun.enrich.f, echo=TRUE, message=FALSE, fig.cap="\\label{tumor8}Figure 25.F: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in females comparison", autodep=TRUE}
...
```{r fun.enrich.m, echo=TRUE, message=FALSE, fig.cap="\\label{tumor9}Figure 25.G: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in males comparison", autodep=TRUE}
