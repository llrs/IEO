...
We conclude that there isn't a batch effect due to this variables. But to doble check we perform a PCA:
...
for (batching in list(portionanalyte, samplevial)){
    ...
    legend("bottomleft", paste("Batch", sort(unique(batch)), levels(factor(batching))),
