...
There is a low correlation on the counts and the GC content or the length but as there are clearly two groups based on the length, we will normalize also using the length with the package cqn:
