...
```{r mds3, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap = "\\label{mds3}Figure 19: Multidimensional scaling plot of the samples.", autodep=TRUE}
batch_effects <- list(portion, tss, as.character(thca.filtered$type),
                      as.character(thca.filtered$gender))
for (batching in batch_effects){
    batch <- as.integer(factor(batching))
...
```{r clustring.svd3, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.svd3}Figure 20.C: Hierarchical clustering of the samples with SVD for type", autodep=TRUE}
...
their expression at FDR < 1%. In Figure 19 below we show the distribution of the
resulting p-values.

```{r pdist, out.width = "500px", fig.cap ="\\label{pdist}Figure 21.A: Distribution of raw p-values for an F-test on every gene between tumor and normal samples.", autodep=TRUE}
hist(pv, main = "Histogram of p-values", las = 1)
```

```{r pdist2, out.width = "500px", fig.cap = "\\label{pdist2}Figure 21.B: Distribution of raw p-values for an F-test on every gene between tumor and normal samples.", autodep=TRUE}
...
Figure 21 shows the resulting distribution of p-values.

```{r psvdist, out.width = "500px", fig.cap = "\\label{psvdist}Figure 22.A: Distribution of raw p-values for an F-test on every gene between tumor and normal samples, adjusting for surrogate variables estimated with SVA.", autodep=TRUE}
hist(pvsv, main = "Histogram of p-values adjusting surrogate variables", 
     las = 1)
```

```{r psvdist2, out.width = "500px", fig.cap ="\\label{psvdist2}Figure 22.B: Distribution of raw p-values for an F-test on every gene between tumor and normal samples, adjusting for surrogate variables estimated with SVA.", autodep=TRUE}
hist(pvsv, main = "Histogram of p-values adjusting surrogate variables", 
...
```{r DE, autodep=TRUE, fig.cap="\\label{voom} Figure 23: The effect of the normalization by voom."}
...
```{r accuracy,  fig.cap="\\label{accuracy}Figure 24.A: P-value distribution and comparison with the t-student distribution in the comparison Males vs Females.", autodep=TRUE}
...
```{r accuracy2, fig.cap="\\label{accuracy2}Figure 24.B: P-value distribution and comparison with the t-student distribution in the comparison Tumoral and Healthy samples.", autodep=TRUE}
pars <- par(mfrow = c(1, 2), mar = c(4, 5, 2, 2))
...
```{r accuracy3, fig.cap="\\label{accuracy3}Figure 24.C: P-value distribution and comparison with the t-student distribution in the female comparison tumoral and healthy samples.", autodep=TRUE}
pars <- par(mfrow = c(1, 2), mar = c(4, 5, 2, 2))
...
```{r accuracy4, fig.cap="\\label{accuracy4}Figure 24.D: P-value distribution and comparison with the t-student distribution in the male comparison tumoral and healthy samples.", autodep=TRUE}
pars <- par(mfrow = c(1, 2), mar = c(4, 5, 2, 2))
...
```{r volcanoplot, fig.cap="\\label{volcano1}Figure 25.A: Volcano plot of the comparison healthy vs tumoral.", autodep=TRUE}
...
```{r volcano2, fig.cap="\\label{volcano2}Figure 25.B: Volcano plot of the comparison males vs females.", autodep=TRUE}
volcano(tt_gender, "Comparing females vs males")
```

```{r volcano3, fig.cap="\\label{volcano3}Figure 25.C: Volcano plot of the comparison healthy males vs tumoral males.", autodep=TRUE}
volcano(tt_males, "Comparing males: tumoral vs normal")
```

```{r volcano4, fig.cap="\\label{volcano4}Figure 25.C: Volcano plot of the comparison healthy fremales vs tumoral females.", autodep=TRUE}
...
```{r venn_plots, message=FALSE, warning=FALSE, fig.cap="\\label{venn1}Figure 26.A: Representation of the number of genes differentially expressed in comparison between females, and healthy vs tumoral.", autodep=TRUE}
library("Vennerable")
plot(Venn(list(DE_tumor, DE_females),
              SetNames = c("Tumoral", "Females")))
```

```{r venn2, fig.cap="\\label{venn2}Figure 26.B: Representation of the number of genes differentially expressed in comparison between males, and healthy vs tumoral.", autodep=TRUE}
plot(Venn(list(DE_tumor, DE_males),
              SetNames = c("Tumoral", "Males")))
```

```{r venn3, fig.cap="\\label{venn3}Figure 26.C: Representation of the number of genes differentially expressed in comparison between males and females.", autodep=TRUE}
...
```{r fun.enrich.t, fig.cap="\\label{tumor1}Figure 27.A: Representation of the P-value and effect of the GO of the comparison of healty and tumoral samples.", autodep=TRUE}
...
```{r fun.enrich.f, echo=TRUE, message=FALSE, fig.cap="\\label{tumor2}Figure 27.B: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in females comparison", autodep=TRUE}
...
```{r fun.enrich.m, echo=TRUE, message=FALSE, fig.cap="\\label{tumor2}Figure 27.C: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in males comparison", autodep=TRUE}
...
```{r fun.enrich.g, echo=TRUE, message=FALSE, fig.cap="\\label{tumor3}Figure 27.D: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in females againts males", autodep=TRUE}
...
```{r fun.enrich.gender_tumors, echo=TRUE, message=FALSE, fig.cap="\\label{tumor4}Figure 27.E: Representation of the P-value and effect of the GO of the comparison of differentially expressed genes exclusivly from females", autodep=TRUE}
...
```{r fun.enrich., eval=FALSE, message=FALSE, fig.cap="\\label{tumor5}Figure 27.F: Representation of the P-value and effect of the GO of the comparison of differentially expressed genes exclusivly from males", autodep=TRUE}
...
```{r fun.enrich.fmu, eval=FALSE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor6}Figure 27.G: Representation of the P-value and effect of the GO of the up-regulated genes in both  male and female comparisons", autodep=TRUE}
...
```{r fun.enrich.fmd, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor7}Figure 27.H: Representation of the P-value and effect of the GO of the down-regulated genes in both  male and female comparisons", autodep=TRUE}
...
```{r fun.enrich.tfn, eval=FALSE, message=FALSE, fig.cap="\\label{tumor8}Figure 27.I: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and females", autodep=TRUE}
...
```{r fun.enrich.tfu, eval=FALSE, message=FALSE, fig.cap="\\label{tumor9}Figure 27.J: Representation of the P-value and effect of the GO of the genes up-regulated in both comparisons between normal and tumors and tumor vs normal in females.", autodep=TRUE}
...
```{r fun.enrich.tfd, echo=TRUE, message=FALSE, fig.cap="\\label{tumor10}Figure 27.K: Representation of the P-value and effect of the GO of the genes down-regulated in both comparisons between normal and tumors and tumor vs normal in females.", autodep=TRUE}
...
```{r fun.enrich.tmn, echo=TRUE, message=FALSE, fig.cap="\\label{tumor11}Figure 27.L: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in males againts tumor comparison", autodep=TRUE}
...
```{r fun.enrich.tmu, eval=FALSE, message=FALSE, fig.cap="\\label{tumor12}Figure 27.M: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes up-regulated in both tumors vs normal in males and tumor vs normals.", autodep=TRUE}
...
```{r fun.enrich.tmd, echo=TRUE, message=FALSE, fig.cap="\\label{tumor13}Figure 27.N: Representation of the P-value and effect of the GO of the genes down-regulated in both comparisons between normal and tumors and tumor vs normal in males.", autodep=TRUE}
