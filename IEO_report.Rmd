...
```{r exprdist, out.width = "400px", fig.cap =  fig.cap = "\\label{exprdist}Figure 11: Distribution of average expression level per gene using DGE normalization and cqn normalization"}
par(mfrow = c(1, 2))
...
```{r fun.enrich.visualize_tumors, message=FALSE, warning=FALSE}
library(xtable)
