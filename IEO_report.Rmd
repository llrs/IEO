...
author: "[Lluís Revilla](mailto:lluis.revilla01@estudiant.upf.edu), [Marina Reixachs](mailto:marina.reixachs01@estudiant.upf.edu), [Inés Sentís](mailto:ines.sentis01@estudiant.upf.edu), [Mauro Álvarez](mailto:mauro.alvarez01@estudiant.upf.edu)"
date: "19th June 2016"
output:
  html_document:
    theme: united
...
```{r col.data.analysis3, fig.cap="\\label{col.data.analysis3}Figure 2.B: A zoom on the most informative variables.", autodep=TRUE}
...
```{r maPlotsNormal, fig.height = 16, fig.cap = "\\label{maPlotsNormal}Figure 13.B: MA-plots of the normal samples.", autodep=TRUE}
par(mfrow = c(9, 3), mar = c(4, 3, 4, 1))
...
```{r clustering.combat, message=FALSE, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap = "\\label{clustering.combat}Figure 16.A: Hierarchical clustering of the samples with ComBat correction colored by samplevial.", autodep=TRUE}
library("sva")
...
```{r clustering.combat2, message=FALSE, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap = "\\label{clustering.combat2}Figure 16.B: Hierarchical clustering of the samples with ComBat correction coloured by tissues sourec site", autodep=TRUE}
plot.batch(cluster.combat, tss, thca.filtered, outcome)
```

```{r clustering.combat3, message=FALSE, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap = "\\label{clustering.combat3}Figure 16.C: Hierarchical clustering of the samples with ComBat correction coloured by gender.", autodep=TRUE}
plot.batch(cluster.combat, thca.filtered$gender, thca.filtered, outcome)
```

```{r clustering.combat4, message=FALSE, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap ="\\label{clustering.combat4}Figure 16.D: Hierarchical clustering of the samples with ComBat coloured by type.", autodep=TRUE}
plot.batch(cluster.combat, thca.filtered$type, thca.filtered, outcome)
```

```{r clustering.combat5, message=FALSE, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap ="\\label{clustering.combat5}Figure 16.D: Hierarchical clustering of the samples with ComBat coloured by portion", autodep=TRUE}
...
```{r mds2, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap = "\\label{mds}Figure 17: Multidimensional scaling plot of the samples.", autodep=TRUE}
...
```{r clustering.QRdecomposition.1, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.QRdecomposition.1}Figure 18.A: Hierarchical clustering of the samples with QR descompostion for sample vial", autodep=TRUE}
library("limma")
...
```{r clustering.QRdecomposition.2, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.QRdecomposition.2}Figure 18.B: Hierarchical clustering of the samples with QR descompostion for TSS", autodep=TRUE}
plot.batch(cluster.qr, tss, thca.filtered, outcome)
```

```{r clustering.QRdecomposition.3, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.QRdecomposition.3}Figure 18.C: Hierarchical clustering of the samples with QR descompostion for gender", autodep=TRUE}
plot.batch(cluster.qr, thca.filtered$gender, thca.filtered, outcome)
```

```{r clustering.QRdecomposition.4, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.QRdecomposition.4}Figure 18.D: Hierarchical clustering of the samples with QR descompostion for type", autodep=TRUE}
plot.batch(cluster.qr, thca.filtered$type, thca.filtered, outcome)
```

```{r clustering.QRdecomposition.5, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.QRdecomposition.5}Figure 18.E: Hierarchical clustering of the samples with QR descompostion for portion", autodep=TRUE}
...
```{r mds3, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap = "\\label{mds}Figure 19: Multidimensional scaling plot of the samples with qrexp.", autodep=TRUE}
for (batching in batch_effects){
    batch <- as.integer(factor(batching))
    names(batch) <- sample_names
...
```{r clustring.svd1, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.svd1}Figure 20.A: Hierarchical clustering of the samples with SVD for sample vial", autodep=TRUE}
library("corpcor")
...
```{r clustring.svd2, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.svd2}Figure 20.B: Hierarchical clustering of the samples with SVD for TSS", autodep=TRUE}
plot.batch(cluster.svd, tss, thca.filtered, outcome)
```

```{r clustring.svd3, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.svd3}Figure 20.C: Hierarchical clustering of the samples with SVD for gender", autodep=TRUE}
plot.batch(cluster.svd, thca.filtered$gender, thca.filtered, outcome)
```

```{r clustring.svd4, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.svd4}Figure 20.D: Hierarchical clustering of the samples with SVD for type", autodep=TRUE}
plot.batch(cluster.svd, thca.filtered$type, thca.filtered, outcome)
```

```{r clustring.svd5, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap="\\label{clustering.svd3}Figure 20.E: Hierarchical clustering of the samples with SVD for portion", autodep=TRUE}
...
We perform a simple examination of expression changes and their associated p-values using the R/Bioconductor package [sva](http://bioconductor.org/packages/sva) using the models previously created.
...
* In [GO_gender_table](GO_gender_table.html) we have the list of GO enrich on the differentially expressed genes in the comparison between females and males.    
