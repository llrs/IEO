...
output:
  ...
  pdf_document:
    toc: yes
---
```{r setup0, message = FALSE, warning = FALSE, include = FALSE}
library("knitr")
...
```
```{r setup3, message = FALSE, warning = FALSE, eval = FALSE, include = FALSE}
library("knitr")
library("plyr")
...
```{r maPlotsTumor, fig.height = 13, fig.width = 6, dpi = 100, fig.cap = "\\label{maPlotsTumor}Figure 13.A: MA-plots of the tumor samples.", autodep=TRUE}
...
```{r maPlotsNormal, fig.height = 13, fig.width = 6, dpi = 100, fig.cap = "\\label{maPlotsNormal}Figure 13.B: MA-plots of the normal samples.", autodep=TRUE}
par(mfrow = c(8, 3), mar = c(4, 3, 4, 1))
...
```{r accuracy,  fig.cap="\\label{accuracy}Figure 21.A: P-value distribution and comparison with the t-student distribution in the comparison Males vs Females.", autodep=TRUE}
...
```
```{r accuracy2, fig.cap="\\label{accuracy2}Figure 21.B: P-value distribution and comparison with the t-student distribution in the comparison Tumoral and Healthy samples.", autodep=TRUE}
pars <- par(mfrow = c(1, 2), mar = c(4, 5, 2, 2))
...
mtext("Comparing genes between healthy and tumoral patients", 
      outer = TRUE, cex = 1.5, side = 3, line = -2)
```
```{r accuracy3, fig.cap="\\label{accuracy3}Figure 21.C: P-value distribution and comparison with the t-student distribution in the female comparison tumoral and healthy samples.", autodep=TRUE}
pars <- par(mfrow = c(1, 2), mar = c(4, 5, 2, 2))
...
mtext("Comparing genes between females patients and healthy.", outer = TRUE, cex = 1.5, 
      side = 3, line = -2)
```
```{r accuracy4, fig.cap="\\label{accuracy4}Figure 21.D: P-value distribution and comparison with the t-student distribution in the male comparison tumoral and healthy samples.", autodep=TRUE}
pars <- par(mfrow = c(1, 2), mar = c(4, 5, 2, 2))
...
```{r volcanoplot, fig.cap="\\label{volcano1}Figure 22.A: Volcano plot of the comparison healthy vs tumoral.", autodep=TRUE}
...
```
```{r volcano2, fig.cap="\\label{volcano2}Figure 22.B: Volcano plot of the comparison males vs females.", autodep=TRUE}
volcano(tt_gender, "Comparing males vs females")
```
```{r volcano3, fig.cap="\\label{volcano3}Figure 22.C: Volcano plot of the comparison healthy males vs tumoral males.", autodep=TRUE}
volcano(tt_males, "Comparing males: healthy vs tumoral")
```
```{r volcano4, fig.cap="\\label{volcano4}Figure 22.C: Volcano plot of the comparison healthy fremales vs tumoral females.", autodep=TRUE}
...
```{r venn_plots, message=FALSE, warning=FALSE, fig.cap="\\label{venn1}Figure 23.A: Representation of the number of genes differentially expressed in comparison between females, and healthy vs tumoral.", autodep=TRUE}
library("Vennerable")
plot(Venn(list(DE_tumor, DE_females),
              SetNames = c("Tumoral", "Females")))
```
```{r venn2, fig.cap="\\label{venn2}Figure 23.B: Representation of the number of genes differentially expressed in comparison between males, and healthy vs tumoral.", autodep=TRUE}
plot(Venn(list(DE_tumor, DE_males),
              SetNames = c("Tumoral", "Males")))
```
```{r venn3, fig.cap="\\label{venn3}Figure 23.C: Representation of the number of genes differentially expressed in comparison between males and females.", autodep=TRUE}
...
```{r fun.enrich.tumor_tumors, message=FALSE, warning=FALSE, fig.cap="\\label{tumor1}Figure 24.A: Representation of the P-value and effect of the GO of the comparison of healty and tumoral samples.", autodep=TRUE}
...
```{r fun.enrich.gender_tumors, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor3}Figure 24.B: Representation of the P-value and effect of the GO of the comparison of differentially expressed genes exclusivly from females", autodep=TRUE}
...
```{r fun.enrich.fmu, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor3}Figure 24.C: Representation of the P-value and effect of the GO of the up-regulated genes in both  male and female comparisons", autodep=TRUE}
...
```{r fun.enrich.fmd, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor4}Figure 24.D: Representation of the P-value and effect of the GO of the down-regulated genes in both  male and female comparisons", autodep=TRUE}
...
```{r fun.enrich.tmd, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor5}Figure 24.E: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and males.", autodep=TRUE}
...
```{r fun.enrich.tfu, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor6}Figure 24.F: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and females", autodep=TRUE}
...
```{r fun.enrich.tfd, echo=TRUE, message=FALSE, fig.cap="\\label{tumor7}Figure 24.G: Representation of the P-value and effect of the GO of the genes with down-regulation in the comparison between normal and tumors and females", autodep=TRUE}
