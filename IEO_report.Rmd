...
mod0 <- model.matrix(~ 1 + type , data = colData(thca.filtered))
...
go_obj <- function(genes_id, universe = unique(all.Human.GO$ENTREZID)){
...
```{r fun.enrich.tfu, echo=TRUE, message=FALSE, fig.cap="\\label{tumor6}Figure 25.E: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and females", autodep=TRUE}
...
```{r fun.enrich.tfd, echo=TRUE, message=FALSE, fig.cap="\\label{tumor7}Figure 25.F: Representation of the P-value and effect of the GO of the genes with down-regulation in the comparison between normal and tumors and females", autodep=TRUE}
...
```{r fun.enrich.f, echo=TRUE, message=FALSE, fig.cap="\\label{tumor8}Figure 25.G: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in females comparison", autodep=TRUE}
...
```{r fun.enrich.m, echo=TRUE, message=FALSE, fig.cap="\\label{tumor9}Figure 25.H: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in males comparison", autodep=TRUE}
...
```{r tables_GO, message=FALSE, warning=FALSE, autodep=TRUE}
library(xtable)
...
go_table(GO_tumor_females_down$GO, "GO_tumor_females_down_table.html")
