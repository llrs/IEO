...
```{r, include=FALSE}
save.image(file="Before_Differential_expression_of_paired_data.RData")
```
...
```{r volcano3, eval=FALSE, fig.cap="\\label{volcano3}Figure 23.C: Volcano plot of the comparison healthy males vs tumoral males.", autodep=TRUE, include=FALSE}
...
save.image(file="Before_Genes_differentially_expressed.RData")
```
...
```{r venn2, eval=FALSE, fig.cap="\\label{venn2}Figure 24.B: Representation of the number of genes differentially expressed in comparison between males, and healthy vs tumoral.", autodep=TRUE, include=FALSE}
# plot(Venn(list(DE_tumor, DE_males),
              # SetNames = c("Tumoral", "Males")))
```

```{r venn3, eval=FALSE, fig.cap="\\label{venn3}Figure 24.C: Representation of the number of genes differentially expressed in comparison between males and females.", autodep=TRUE, include=FALSE}
...
```{r fun.enrich.m, eval=FALSE, fig.cap="\\label{tumor2}Figure 25.C: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in males comparison", message=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich.gender_tumors, eval=FALSE, fig.cap="\\label{tumor4}Figure 25.E: Representation of the P-value and effect of the GO of the comparison of differentially expressed genes exclusivly from females", message=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich., eval=FALSE, fig.cap="\\label{tumor5}Figure 25.F: Representation of the P-value and effect of the GO of the comparison of differentially expressed genes exclusivly from males", message=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich.fmu, eval=FALSE, fig.cap="\\label{tumor6}Figure 25.G: Representation of the P-value and effect of the GO of the up-regulated genes in both  male and female comparisons", message=FALSE, warning=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich.fmd, eval=FALSE, fig.cap="\\label{tumor7}Figure 25.H: Representation of the P-value and effect of the GO of the down-regulated genes in both  male and female comparisons", message=FALSE, warning=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich.tfn, eval=FALSE, fig.cap="\\label{tumor8}Figure 25.I: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and females", message=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich.tfu, eval=FALSE, fig.cap="\\label{tumor9}Figure 25.J: Representation of the P-value and effect of the GO of the genes up-regulated in both comparisons between normal and tumors and tumor vs normal in females.", message=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich.tmn, eval=FALSE, fig.cap="\\label{tumor11}Figure 25.L: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in males againts tumor comparison", message=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich.tmu, eval=FALSE, fig.cap="\\label{tumor12}Figure 25.M: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes up-regulated in both tumors vs normal in males and tumor vs normals.", message=FALSE, autodep=TRUE, include=FALSE}
...
```{r fun.enrich.tmd, eval=FALSE, fig.cap="\\label{tumor13}Figure 25.N: Representation of the P-value and effect of the GO of the genes down-regulated in both comparisons between normal and tumors and tumor vs normal in males.", message=FALSE, autodep=TRUE, include=FALSE}
