...
```{r maPlotsTumor, fig.height = 10, fig.width = 6, dpi = 100, fig.cap = "\\label{maPlotsTumor}Figure 13.A: MA-plots of the tumor samples.", autodep=TRUE}
...
```{r maPlotsNormal, fig.height = 10, fig.width = 6, dpi = 100, fig.cap = "\\label{maPlotsNormal}Figure 13.B: MA-plots of the normal samples.", autodep=TRUE}
par(mfrow = c(8, 3), mar = c(4, 3, 4, 1))
...
fit <- lmFit(vo, design, block = thca.filtered$bcr_patient_barcode,
...
We can compare if in the different comparisons such genes remain allways up-regulated or down-regulated. But we create some function to make it easier to compare several lists:
...
```{r fun.enrich.params_tumors, message=FALSE, autodep=TRUE}
library(GOstats)
...
```{r fun.enrich.gender_tumors, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor3}Figure 25.B: Representation of the P-value and effect of the GO of the comparison of differentially expressed genes exclusivly from females", autodep=TRUE}
...
```{r fun.enrich.fmu, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor3}Figure 25.C: Representation of the P-value and effect of the GO of the up-regulated genes in both  male and female comparisons", autodep=TRUE}
...
```{r fun.enrich.fmd, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor4}Figure 25.D: Representation of the P-value and effect of the GO of the down-regulated genes in both  male and female comparisons", autodep=TRUE}
...
```{r fun.enrich.tmd, echo=TRUE, message=FALSE, fig.cap="\\label{tumor5}Figure 25.E: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and males.", autodep=TRUE}
...
```{r fun.enrich.tfd, echo=TRUE, message=FALSE, fig.cap="\\label{tumor7}Figure 25.G: Representation of the P-value and effect of the GO of the genes with down-regulation in the comparison between normal and tumors and females", autodep=TRUE}
...
```{r fun.enrich.f, echo=TRUE, message=FALSE, fig.cap="\\label{tumor8}Figure 25.H: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in females comparison", autodep=TRUE}
...
```{r fun.enrich.m, echo=TRUE, message=FALSE, fig.cap="\\label{tumor9}Figure 25.I: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in males comparison", autodep=TRUE}
...
```{r fun.enrich.visualize_tumors, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, autodep=TRUE}
library(xtable)
