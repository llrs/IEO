...
colData(thca.filtered) <- filtered
```
...
```{r maPlotsTumor, fig.height = 16, fig.width = 6, dpi = 100, fig.cap = "Figure S4: MA-plots of the tumor samples.", cache=TRUE}
...
```{r maPlotsNormal, fig.height = 16, fig.width = 6, dpi = 100, fig.cap = "Figure S5: MA-plots of the normal samples.", cache=TRUE}
par(mfrow = c(8, 3), mar = c(4, 5, 3, 1))
