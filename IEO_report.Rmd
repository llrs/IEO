...
```{r clustering.combat4, message=FALSE, fig.height = 7, fig.width = 14, dpi = 100, echo = TRUE, fig.cap ="\\label{clustering.combat3}Figure 16.D: Hierarchical clustering of the samples with ComBat coloured by tissue sample site.", autodep=TRUE}
