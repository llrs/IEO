...
```{r plots, fig.cap = fig$cap("Figure S1.A","Exploring the col.data")}
...
```{r plots, fig.cap = fig$cap("Figure S1.B","Exploring the col.data")}
...
```{r plots, fig.cap = fig$cap("Figure S1.C","Exploring the col.data")}
...
```{r plots, fig.cap = fig$cap("Figure S1.D","Exploring the col.data")}
...
```{r plots, fig.cap = fig$cap("Figure S1.E","Exploring the col.data")}
...
```{r plots, fig.cap = fig$cap("Figure S1.F","Exploring the col.data")}
...
```{r plots, fig.cap = fig$cap("Figure S1.H","Exploring the col.data")}
...
```{r plots, fig.cap = fig$cap("Figure S1.I","Exploring the col.data")}
