...
```{r subset.explore3, fig.cap="\\label{pairedge}Figure 4.C: The samples not from the tumor are correclty assigned NA", autodep=TRUE}
...
```{r subset.explore4, fig.cap="\\label{paireda}Figure 4.D: The paired data comprises a wide range of period of life, from people with 18 years to 81", autodep=TRUE}
