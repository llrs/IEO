...
```{r libsizes1, echo=FALSE, out.width="600px", fig.cap="\\label{libsize1}Figure 5.A: Library sizes in increasing order of the whole dataset", autodep=TRUE}
...
```{r libsizes2, echo=FALSE, out.width="600px", fig.cap="\\label{libsize2}Figure 5.B: Library sizes in increasing order of the paired data.", autodep=TRUE}
...
# And the null model
mod0 <- model.matrix(~ gender + type + paired, data = colData(thca.filtered))
head(mod0)
```
...
```{r fun.enrich., echo=TRUE, message=FALSE, fig.cap="\\label{tumor5}Figure 25.F: Representation of the P-value and effect of the GO of the comparison of differentially expressed genes exclusivly from males", autodep=TRUE}
...
```{r fun.enrich.fmu, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="\\label{tumor6}Figure 25.G: Representation of the P-value and effect of the GO of the up-regulated genes in both  male and female comparisons", autodep=TRUE}
...
```{r fun.enrich.tfn, echo=FALSE, message=FALSE, fig.cap="\\label{tumor8}Figure 25.I: Representation of the P-value and effect of the GO of the genes with different regulation in the comparison between normal and tumors and females", autodep=TRUE}
...
```{r fun.enrich.tfu, echo=TRUE, message=FALSE, fig.cap="\\label{tumor9}Figure 25.J: Representation of the P-value and effect of the GO of the genes up-regulated in both comparisons between normal and tumors and tumor vs normal in females.", autodep=TRUE}
...
```{r fun.enrich.tmn, echo=FALSE, message=FALSE, fig.cap="\\label{tumor11}Figure 25.L: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes in males againts tumor comparison", autodep=TRUE}
...
```{r fun.enrich.tmu, echo=TRUE, message=FALSE, fig.cap="\\label{tumor12}Figure 25.M: Representation of the P-value and effect of the GO of the genes with the differentially expressed genes up-regulated in both tumors vs normal in males and tumor vs normals.", autodep=TRUE}
...
table_h(de_tumor, "DE_tumor.html")
table_h(de_gender, "DE_gender.html")
table_h(de_females, "DE_females.html")
table_h(de_males, "DE_males.html")
```
